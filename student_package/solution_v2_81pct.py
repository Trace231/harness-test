...
class MyHarness(Harness):
    ...
    def predict(self, text: str) -> str:
        ...
        system_content = (
            "You are a strict text classifier. Output exactly one label "
            "from the allowed set below. Some labels include a short "
            "description that highlights what distinguishes them from "
            "similar labels — use these descriptions to disambiguate.\n\n"
            f"Allowed labels:\n{labels_block}\n\n"
